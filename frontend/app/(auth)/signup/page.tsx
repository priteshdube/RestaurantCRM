      ...
      <div className="hidden lg:flex lg:w-1/2 bg-linear-to-br from-emerald-600 to-teal-700 flex-col justify-between p-12 text-white">
        ...
        <div className="space-y-6">
          <h1 className="text-4xl font-bold leading-snug">
            Start tracking<br />what matters.
          </h1>
          <p className="text-emerald-100 text-lg leading-relaxed max-w-sm">
            Join FreshTrack and take control of your restaurant inventory from day one.
          </p>
        </div>

        <div className="flex items-center gap-4 text-sm text-emerald-200">
          <span>Free to get started &mdash; no credit card required</span>
        </div>
      </div>
      ...
      <div className="flex-1 flex items-center justify-center bg-white px-6 py-12">
        <div className="w-full max-w-sm space-y-8">
          ...
          <div className="space-y-1">
            ...
            <p className="text-sm text-gray-500">Get started with FreshTrack for free</p>
          </div>
          ...
          <p className="text-sm text-center text-gray-500">
            ...
            <a href="/signin" className="font-medium text-emerald-600 hover:text-emerald-700 transition-colors">
              Sign in
            </a>
          </p>
        </div>
